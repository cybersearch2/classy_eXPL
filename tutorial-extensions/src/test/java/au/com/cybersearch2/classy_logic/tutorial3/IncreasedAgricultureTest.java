...
public class IncreasedAgricultureTest
{
    ...
    @Test
    public void test_IncreasedAgriculture_2_resource() throws Exception
    {
        IncreasedAgriculture3 increasedAgriculture3 = new IncreasedAgriculture3();
        Iterator<Axiom> iterator = increasedAgriculture3.displayIncreasedAgri();
